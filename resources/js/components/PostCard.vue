...
<template>
    <article class="flex flex-col overflow-hidden rounded-lg border border-[#19140035] bg-white shadow-xs transition-shadow hover:shadow-md dark:border-[#3E3E3A] dark:bg-[#161615]">
